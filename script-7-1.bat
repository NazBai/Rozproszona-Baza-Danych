...
timeout 2 > NUL
start java DatabaseNode -tcpport 9002 -connect localhost:9000 -connect localhost:9009 -record 3:6
timeout 2 > NUL
start java DatabaseNode -tcpport 9003 -connect localhost:9009 -record 4:5
timeout 2 > NUL
start java DatabaseNode -tcpport 9004 -connect localhost:9009 -connect localhost:9003 -record 5:4
timeout 2 > NUL
